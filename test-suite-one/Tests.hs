...
main = defaultMainWithIngredients myIngredients $
  testGroup "Private Internal Test Suite One"
            [internalTests]
...
exampleTests1 =
  testGroup
    ...
    [
      testCase "Failing Test" (assertEqual "A" False True)
    , testCase "Passing Test" (assertEqual "B" True True)
    ]
...
exampleTests2 =
  testGroup
    ...
    [
      testCase "Failing Test" (assertEqual "C"False True)
    , testCase "Passing Test" (assertEqual "D"True True)
    ]
